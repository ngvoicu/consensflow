...
This is a planning draft. These commands are not implemented in the current app;
do not attempt them there. The production skill must be shipped with the
corresponding commands and remove this draft notice.
